...
import {camelCase, type ITokenList, TokenList} from "@protorians/core"
  ...
  export class Morphic<T extends HTMLElement, A extends IAttributes>
    ...
    prepare(): this {
      ...
      if (this._instance) {
        ...
        this.hooks = {
          attributes: new SignalHook.Controller(this._instance.attributes as A),
          dataset: new SignalHook.Controller(this._instance.dataset),
          style: new SignalHook.Controller(this._instance.style),
          classList: new SignalHook.Controller(this._instance.classList),
        }
